    ...
    private void configureMenu() {
        ...
        openFile.setOnAction(event -> {
            ...
            try {
               ...
               showMessage("Nie można otworzyć pliku: " + file.getName()); //ignore
            }
        });
        ...
        openDir.setOnAction(event -> {
            ...
            try {
                ...
                showMessage("Wczytano dane z filderu: " + dir.getName());
            } catch (Exception e) {
                showMessage("Wystąpił błąd podczas odczytu folderu"); //ignore
            }
        });
    }
